...
df11 = pd.read_csv('./mergeResult/results_50e_l1.csv')

#merged_df['Prediction'] = ( merged_df['Prediction_1'] + merged_df['Prediction_6'] + merged_df['Prediction_7'] + merged_df['Prediction_9'] + merged_df['Prediction_11']) / 5
...
merged_df['Prediction'] = ( merged_df['Prediction_9'] + merged_df['Prediction_7']) / 2
...
result_df.to_csv('merged_new.csv', index=False)